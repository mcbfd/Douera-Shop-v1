...
# Encodage strict : [ -> %5B , ] -> %5D , @ -> %40
DATABASE_URL = os.environ.get('DATABASE_URL') or "postgresql://postgres:%5BB%40c%40lori%402015%5D@db.wfdoqlomlpsowxzwfxfu.supabase.co:5432/postgres?sslmode=require"
